...
class Var(object):
    ...
    BOT_TOKEN = str(getenv('BOT_TOKEN', "5722220396:AAH8I2WVl2JrSf81_7hpQq49jaWTXDFEmj8"))
    ...
    OWNER_ID = set(int(x) for x in os.environ.get("OWNER_ID", "5505368975").split())  
    NO_PORT = bool(getenv('NO_PORT', False))
    APP_NAME = None
    OWNER_USERNAME = str(getenv('OWNER_USERNAME', "aaotts"))
    if 'DYNO' in environ:
        ON_HEROKU = True
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', -1001703555051))
